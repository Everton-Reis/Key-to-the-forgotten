...
class Player:
	...
	def draw_status(self, screen) -> None:
		...
		h_surface = self.font.render(h_text, True, (255,255,255))
		screen.blit(h_surface, (10,300))
		speed_surface = self.font.render(speed_text, True, (255,255,255))
		screen.blit(speed_surface, (10, 350))
		jump_surface = self.font.render(jump_text, True, (255,255,255))
		screen.blit(jump_surface, (10, 400))
		dash_surface = self.font.render(dash_text, True, (255,255,255))
		screen.blit(dash_surface, (10, 450))
		shoot_surface = self.font.render(shoot_text, True, (255,255,255))
		screen.blit(shoot_surface, (10, 500))
		ls_surface = self.font.render(ls_text, True, (255,255,255))
		screen.blit(ls_surface, (10, 550))
		level_surface = self.font.render(level_text, True, (255,255,255))
		screen.blit(level_surface, (10, 600))
		exp_surface = self.font.render(exp_text, True, (255,255,255))
		screen.blit(exp_surface, (10, 650))
		next_level_surface = self.font.render(next_level_text, True, (255,255,255))
